...
class WpProQuiz_Plugin_BpAchievementsV3 extends DPA_Extension
{
    ...
    {
        $this->actions = array(
            'wp_pro_quiz_completed_quiz' => __('O usuário completou um questionário.', 'wp-pro-quiz'),
            'wp_pro_quiz_completed_quiz_100_percent' => __('O usuário completou um questionário com 100 por cento.', 'wp-pro-quiz')
        );
