    ...
    public function show()
    {
        ...
        <div class="wrap wpProQuiz_statisticsNew">
            ...
            <div style="padding: 10px 0px;" class="wpProQuiz_tab_wrapper">
                <a class="button-primary" href="#" data-tab="#wpProQuiz_tabHistory"><?php _e('História',
                        'wp-pro-quiz'); ?></a>
                <a class="button-secondary" href="#" data-tab="#wpProQuiz_tabOverview"><?php _e('Visão geral',
                        'wp-pro-quiz'); ?></a>
            </div>
        ...
        <div id="wpProQuiz_tabHistory" class="wpProQuiz_tabContent" style="display: block;">
                    ...
                    <div class="inside">
                        <ul>
                            <li>
                                <label>
                                    ...
                                    <select id="wpProQuiz_historyUser">
                                        <optgroup label="<?php _e('filtro especial', 'wp-pro-quiz'); ?>">
                                            <option value="-1" selected="selected"><?php _e('todos os usuários',
                                                    'wp-pro-quiz'); ?></option>
                                            <option value="-2"><?php _e('somente usuários registrados',
                                                    'wp-pro-quiz'); ?></option>
                                            <option value="-3"><?php _e('somente usuários anônimos',
                                                    'wp-pro-quiz'); ?></option>
                                        </optgroup>

                                        <optgroup label="<?php _e('Usuário', 'wp-pro-quiz'); ?>">
                            ...
                            <li>
                                ...
                                printf(__('Pesquisar até o limite de data de %s a %s', 'wp-pro-quiz'), $dateVon, $dateBis);
                                ?>
                            </li>
                            <li>
                                <input type="button" value="<?php _e('Filtro', 'wp-pro-quiz'); ?>"
            ...
            <div style="margin-top: 10px;">
                ...
                <div style="float: right;">
                    ...
                    <a class="button-secondary wpProQuiz_export" href="#"><?php _e('Exportar', 'wp-pro-quiz'); ?></a>
        ...
        <div id="wpProQuiz_statsticExportList_box" style="display: none;">
            <div class="wpProQuiz_exportList">
                <form action="" method="POST">
                    ...
                    <p><?php echo __('Selecione um formato', 'wp-pro-quiz'); ?></p>
