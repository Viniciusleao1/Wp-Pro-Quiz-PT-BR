...
class WpProQuiz_View_Statistics extends WpProQuiz_View_View
{
    ...
    public function show()
    {
        ...
        <div class="wrap wpProQuiz_statistics">
            ...
            <h2><?php printf(__('Questionário: %s - Estatísticas', 'wp-pro-quiz'), $this->quiz->getName()); ?></h2>

            <p><a class="button-secondary" href="admin.php?page=wpProQuiz"><?php _e('voltar para a visão geral',
                        'wp-pro-quiz'); ?></a></p>

            <?php if (!$this->quiz->isStatisticsOn()) { ?>
                <p style="padding: 30px; background: #F7E4E4; border: 1px dotted; width: 300px;">
                    <span style="font-weight: bold; padding-right: 10px;"><?php _e('Estatísticas não habilitadas',
                            'wp-pro-quiz'); ?></span>
                    <a class="button-secondary"
                       href="admin.php?page=wpProQuiz&action=addEdit&quizId=<?php echo $this->quiz->getId(); ?>"><?php _e('Ativar estatísticas',
                            'wp-pro-quiz'); ?></a>
                </p>
                <?php return;
            } ?>
            ...
            <div style="padding: 10px 0px;">
                <a class="button-primary wpProQuiz_tab" id="wpProQuiz_typeUser" href="#"><?php _e('Usuários',
                        'wp-pro-quiz'); ?></a>
                <a class="button-secondary wpProQuiz_tab" id="wpProQuiz_typeOverview" href="#"><?php _e('Visão geral',
                        'wp-pro-quiz'); ?></a>
                <a class="button-secondary wpProQuiz_tab" id="wpProQuiz_typeForm" href="#"><?php _e('Campos personalizados',
                        'wp-pro-quiz'); ?></a>
            </div>
            ...
            <div class="wpProQuiz_blueBox" id="wpProQuiz_userBox" style="margin-bottom: 20px;">
                <div style="float: left;">
                    <div style="padding-top: 6px;">
                        <?php _e('Selecione o nome do usuário:', 'wp-pro-quiz'); ?>
                    </div>

                    <div style="padding-top: 6px;">
                        <?php _e('Selecione um questionário:', 'wp-pro-quiz'); ?>
                    </div>
                ...
                <div style="float: left;">
                    <div>
                        <select name="userSelect" id="userSelect">
                            <?php foreach ($this->users as $user) {
                                if ($user->ID == 0) {
                                    echo '<option value="0">=== ', __('Usuário anônimo', 'wp-pro-quiz'), ' ===</option>';
                                } else {
                    ...
                    <div>
                        <select id="testSelect">
                            <option value="0">=== <?php _e('média', 'wp-pro-quiz'); ?> ===</option>
                        </select>
                    </div>
                </div>
            ...
            <div style="margin-top: 10px;">
                ...
                <div style="float: right;">
                    <?php if (current_user_can('wpProQuiz_reset_statistics')) { ?>
                        <a class="button-secondary" href="#" id="wpProQuiz_reset"><?php _e('Redefinir estatísticas',
                                'wp-pro-quiz'); ?></a>
                        <a class="button-secondary" href="#" id="wpProQuiz_resetUser"><?php _e('Redefinir estatísticas do usuário',
                                'wp-pro-quiz'); ?></a>
                        <a class="button-secondary wpProQuiz_resetComplete" href="#"><?php _e('Redefinir estatística inteira',
                                'wp-pro-quiz'); ?></a>
                    <?php } ?>
                </div>
                <div style="clear: both;"></div>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <ul>
                            <li>
                                <label>
                                    <?php _e('Mostrar apenas usuários que resolveram o questionário:', 'wp-pro-quiz'); ?>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <ul>
                            <li>
                                <label>
                                    <?php _e('Quais usuários devem ser exibidos:', 'wp-pro-quiz'); ?>
                                    <select id="wpProQuiz_formUser">
                                        <option value="0"><?php _e('todos', 'wp-pro-quiz'); ?></option>
                                        <option value="1"><?php _e('somente usuários registrados', 'wp-pro-quiz'); ?></option>
                                        <option value="2"><?php _e('somente usuários anônimos', 'wp-pro-quiz'); ?></option>
                                    </select>
                                </label>
                            </li>
                            <li>
