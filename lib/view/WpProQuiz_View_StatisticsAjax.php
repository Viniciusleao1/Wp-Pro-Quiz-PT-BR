...
class WpProQuiz_View_StatisticsAjax extends WpProQuiz_View_View
{
    ...
    public function showHistoryTable()
    {
        ...
        <table class="wp-list-table widefat">
            <thead>
            <tr>
                <th scope="col"><?php _e('Nome de usuário', 'wp-pro-quiz'); ?></th>
                ...
                <th scope="col" style="width: 200px;"><?php _e('Data', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Correta', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Incorreta', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Resolvida', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Pontos', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 60px;"><?php _e('Resultados', 'wp-pro-quiz'); ?></th>
            </tr>
            </thead>
            ...
            <?php if (!count($this->historyModel)) { ?>
                <tr>
                    <td colspan="6"
                        style="text-align: center; font-weight: bold; padding: 10px;"><?php _e('Não há dados disponíveis',
                            'wp-pro-quiz'); ?></td>
                </tr>
            <?php } else { ?>
                    ...
                    <tr>
                        <th>
							...
							<span>
                                ...
                                <span>
                                    <a class="wpProQuiz_export" href="#" data-baseurl="admin.php?page=wpProQuiz&module=statistic_export&action=user_export&quiz_id=<?php echo $model->getQuizId(); ?>&user_id=0&ref_id=<?php echo $model->getStatisticRefId(); ?>&avg=0&noheader=true"><?php _e('Exportar', 'wp-pro-quiz'); ?></a>
                                </span>
                            </div>
                        ...
                        <th><?php echo $model->getSolvedCount() < 0 ? '---' : sprintf(__('%d de %d', 'wp-pro-quiz'),
    ...
    public function showUserTable()
    {
        ...
        <h2><?php printf(__('Estatísticas do usuário: %s', 'wp-pro-quiz'), esc_html($this->userName)); ?></h2>
        <?php if ($this->avg) { ?>
        <h2>
    ...
    <?php } ?>
        ...
        <table class="wp-list-table widefat" style="margin-top: 20px;">
            ...
            <tr>
                ...
                <th scope="col"><?php _e('Questão', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Pontos', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Correta', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Incorreta', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Dicas usadas', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Resolvida', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Tempo', 'wp-pro-quiz'); ?> <span
                        style="font-size: x-small;">(hh:mm:ss)</span></th>
                <th scope="col" style="width: 100px;"><?php _e('Pontos marcados', 'wp-pro-quiz'); ?></th>
                <th scope="col" style="width: 60px;"><?php _e('Resultados', 'wp-pro-quiz'); ?></th>
            </tr>
            </thead>
            <tbody>
            ...
            foreach ($this->userStatistic as $cat) {
                ...
                <tr class="categoryTr">
                    <th colspan="9">
                        <span><?php _e('Categoria', 'wp-pro-quiz'); ?>:</span>
                ...
                <?php foreach ($cat['questions'] as $q) {
                    ...
                    <tr>
                        ...
                        <th><?php echo $q['solvedCount'] < 0 ? '---' : ($q['solvedCount'] ? __('sim',
                                'wp-pro-quiz') : __('não', 'wp-pro-quiz')); ?></th>
                ...
                <tr class="categoryTr" id="wpProQuiz_ctr_222">
                    <th colspan="2">
                        <span><?php _e('Subtotal: ', 'wp-pro-quiz'); ?></span>
                    </th>
                    ...
                    <th><?php echo $cSolvedCount < 0 ? '---' : sprintf(__('%d de %d', 'wp-pro-quiz'), $cSolvedCount,
                            $sum); ?></th>
            ...
            <tr id="wpProQuiz_tr_0">
                ...
                <th><?php echo $gSolvedCount < 0 ? '---' : sprintf(__('%d de %d', 'wp-pro-quiz'), $gSolvedCount,
                        $sum); ?></th>
        ...
        <div style="margin-top: 10px;">
            <div style="float: left;">
                <a class="button-secondary wpProQuiz_update" href="#"><?php _e('Atualizar', 'wp-pro-quiz'); ?></a>
                <a class="button-secondary wpProQuiz_export" href="#" data-baseurl="admin.php?page=wpProQuiz&module=statistic_export&action=user_export&quiz_id=<?php echo $this->quizId; ?>&user_id=<?php echo $this->userId; ?>&ref_id=<?php echo $this->refId; ?>&avg=<?php echo $this->avg; ?>&noheader=true"><?php _e('Exportar', 'wp-pro-quiz'); ?></a>
            </div>
            <div style="float: right;">
                <?php if (current_user_can('wpProQuiz_reset_statistics')) { ?>
                    <a class="button-secondary" href="#" id="wpProQuiz_resetUserStatistic"><?php _e('Redefinir estatísticas',
                            'wp-pro-quiz'); ?></a>
                <?php } ?>
            </div>
                                    ...
                                    <td>
                                        ...
                                        switch ($form->getType()) {
                                            ...
                                            case WpProQuiz_Model_Form::FORM_TYPE_CHECKBOX:
                                                echo $str == '1' ? __('marcada', 'wp-pro-quiz') : __('não marcada',
                                                    'wp-pro-quiz');
                                                break;
        ...
        <table class="wp-list-table widefat">
            ...
            <?php } else { ?>
                ...
                <?php foreach ($this->statisticModel as $model) {
                    ...
                    if (!$model->getUserId()) {
                        $model->setUserName(__('Anônimo', 'wp-pro-quiz'));
                    }
                    ...
                    <tr>
                        <th>
							...
							<span>
                                ...
                                |
                                <span>
                                    <a class="wpProQuiz_export" href="#" data-baseurl="admin.php?page=wpProQuiz&module=statistic_export&action=user_export&quiz_id=<?php echo $this->quizId; ?>&user_id=<?php echo $model->getUserId(); ?>&ref_id=0&avg=1&noheader=true"><?php _e('Exportar', 'wp-pro-quiz'); ?></a>
                                </span>
                            </div>
