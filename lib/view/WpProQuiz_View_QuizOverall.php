...
class WpProQuiz_View_QuizOverall extends WpProQuiz_View_View
{
    ...
    public function show()
    {
        ...
        <div id="wpProQuiz_tab_donat" style="display: none;" class="hide-if-no-js screen-meta-toggle">
            <a href="https://buy.stripe.com/8wM03O9Hj3Rw7oA7ss" class="button show-settings" target="_blank"><?php _e('Doar', 'wp-pro-quiz'); ?></a>
        </div>
        <div class="wrap wpProQuiz_quizOverall" style="">
            <h2>
                <?php _e('Visão geral do questionário', 'wp-pro-quiz'); ?>
                <?php if (current_user_can('wpProQuiz_add_quiz')) { ?>
                    <a class="add-new-h2" href="admin.php?page=wpProQuiz&action=addEdit"><?php echo __('Adicionar questionário',
                            'wp-pro-quiz'); ?></a>
                <?php }
            ...
            <p style="margin-bottom: 0; display: none;">
                <?php if (current_user_can('wpProQuiz_add_quiz')) { ?>
                    <a class="button-secondary" href="admin.php?page=wpProQuiz&action=addEdit"><?php echo __('Adicionar questionário',
                            'wp-pro-quiz'); ?></a>
                <?php }
                if (current_user_can('wpProQuiz_import')) { ?>
                    <a class="button-secondary wpProQuiz_import" href="#"><?php echo __('Importar', 'wp-pro-quiz'); ?></a>
                <?php } ?>
            </p>
        ...
        <div id="wpProQuiz_importList_box" style="display: none;">
            <div class="wpProQuiz_importList">
                <form action="admin.php?page=wpProQuiz&module=importExport&action=import" method="POST"
                    ...
                    <p><?php echo sprintf(__('Formatos suportados: %s', 'wp-pro-quiz'), implode(', ', $this->supportedImportFormats['extensions'])) ?></p>
        ...
        <div id="wpProQuiz_exportList_box" style="display: none;">
            <div class="wpProQuiz_exportList">
                <form action="admin.php?page=wpProQuiz&module=importExport&action=export&noheader=true" method="POST">
                    ...
                    <p><?php echo __('Selecione a respectiva questão que você deseja exportar e clique em "Iniciar exportação"',
                            'wp-pro-quiz'); ?></p>
                    <ul></ul>
        ...
        <div id="wpProQuiz_setQuizCategoryList_box" style="display: none;">
            <div class="wpProQuiz_setQuizCategoryList">
                <form action="#" method="POST">
                    <h3 style="margin-top: 0;"><?php _e('Definir categorias de questionário', 'wp-pro-quiz'); ?></h3>

                    <p><?php _e('Define várias categorias de questionário ', 'wp-pro-quiz'); ?></p>
                    ...
                    <div style="margin-bottom: 10px;">
                        ...
                        <div>
                            <select name="category">
                                ...
                                <option value="0" selected="selected">--- <?php _e('Nenhuma categoria', 'wp-pro-quiz'); ?>
                                    ---
                                </option>
                                <?php
                    ...
                    <input class="button-primary" name="setCategoriesStart" id="setCategoriesStart"
                           value="<?php _e('Salvar', 'wp-pro-quiz'); ?>" type="button">
