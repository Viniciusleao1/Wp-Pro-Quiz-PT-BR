<?php
/**
 * Plugin Name: Wp-Pro-Quiz - Português BR
 * Plugin URI: https://github.com/Viniciusleao1/Wp-Pro-Quiz-PT-BR
 * Description: Um plugin de questionário robusto e elegante para WordPress, com funcionalidades avançadas de criação de testes. Esta versão inclui tradução para Português (BR).
 * Version: 0.38
 * Requires at least: 4.6
 * Requires PHP: 7.4
 * Author: Julius Fischer, Vinicius Leão (Colaborador e Desenvolvedor da Comunidade)
 * Author URI: https://github.com/Viniciusleao1/Wp-Pro-Quiz-PT-BR
 * Text Domain: Wp-Pro-Quiz-PT-BR
 * License: GPL v2 or later
 * License URI: https://www.gnu.org/licenses/gpl-2.0.txt
 *
 * @package Wp-Pro-Quiz-PT-BR
 * @contributors Vinicius Leão @Viniciusleao1
...
require_once(plugin_dir_path(__FILE__) . 'wp-pro-quiz-graphs.php');
