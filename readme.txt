=== Wp-Pro-Quiz-PT-BR ===
Contributors: Viniciusleao1
Donate link: https://buy.stripe.com/8wM03O9Hj3Rw7oA7ss
Tags: quiz, teste, liderança, pontuação, pesquisa, resposta, pergunta, aprendizagem, avaliação
...
Um plugin de quiz poderoso e bonito para WordPress.
...
= O Wp-Pro-Quiz-PT-BR agora está no Github! =
https://github.com/Viniciusleao1/Wp-Pro-Quiz-PT-BR
...
1. Quiz demo - Página inicial
2. Quiz demo - Mensagem correta
3. Quiz demo - Multimídia
4. Quiz demo - Resultados
5. Quiz demo2 - Limite de tempo e botão voltar
6. Quiz demo - Leadboard
7. Quiz demo - Pontuação média
8. Adminmenu - Visão geral do quiz
9. Adminmenu - Criar quiz
10. Adminmenu - Visão geral da pergunta do quiz
11. Adminmenu - Criar pergunta
12. Adminmenu - Estatísticas da pergunta

== Changelog ==

= Não publicado =
* Correção de bug: Adicionar espaço em branco entre o número de pontos e o ponto de sequência na resposta correta
* Tradução para vietnamita foi adicionada (Obrigado vy2014)
* Tradução para chinês simplificado foi adicionada (Obrigado Riley Ge)
* Correção nº 35 - O campo de e-mail não permite letras maiúsculas
